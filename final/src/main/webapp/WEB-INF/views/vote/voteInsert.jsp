		...
		<div>
			<table class="table">
				...
				<tr>
					...
					<td width="300"><input type="text" id="candidate" name="candidate"><button class="btn btn-primary" type="button">검색</button>
					</td>
				</tr>
				<tr>
					<th width="100">투표 시작일</th>
					<td width="300"><input type="date" id="startDate" name="startDate">
					</td>
				</tr>
				<tr>
			...
			<div align="right">
				<button class="btn btn-outline-secondary" onclick="location">등록하기</button>&nbsp;&nbsp;&nbsp;
