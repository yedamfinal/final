      ...
      <div class="container">
            ...
            <div class="col-sm-4">
               <div class="mLogin_box mLogout">
                  ...
                  <div class="loginBox">
                     ...
                     <p>
                        <input type="password" class="login_input_text" id="member_pass"
                           value="" placeholder="비밀번호" style="width: 100%">
         ...
         <div class="mBoard_box">
               ...
               <div class="tab_board_wrap">
                  <ul class="tab_cate" id="notice_ul">
                     <li class="on" id="li_inform"><a
                        href="javascript:board_latest_list('inform','notice')">아파트 공지사항</a></li>
                  </ul>
            ...
            <div class="mBoard comu_board">
               <p class="title">커뮤니티 <span> 입주민간 자유로운 소통 공간!</span>
               </p>
               <div class="tab_board_wrap">
